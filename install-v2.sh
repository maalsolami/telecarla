...
# This install script is based on install.sh that comes with TELECARLA
# It is modified to work with our current setup
...
"$SCRIPT_DIR"/telecarla_rpc/script/install-v2.sh
